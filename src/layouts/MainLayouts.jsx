...
import backgroundProfile from "./../assets/assets_hero_profile.jpg";
export default function MainLayouts({ children, title, path }) {
  return (
    <>
      <MainNavbar />
      <div className="relative">
        ...
        <div className="absolute top-40  right-20">
          <div className="w-64 h-16 bg-white rounded-t-xl">
            <div className="navigasi flex justify-center items-center h-18 gap-5">
              {path}
            </div>
          </div>
        </div>
